        ...
        while len(velocity_trajectory) != 0 and cmd_idx < len(velocity_trajectory):
            ...
            for i, name in enumerate(joint_trajectory["joint_names"]):
                if name == 'base_z':
                    ...
                    base_z_move_rad = base_z_pos - self.base_z_pos_prev
                    self.base_z_pos_prev = base_z_pos
                    ...
                    w, x, y, z= euler_to_quaternion(0, 0, base_z_move_rad)
                    ...
                    print("[debug]base_z_pos:", base_z_pos)
                    # print("[debug]base_z_vel", base_z_action.vel.angular.z)
                    ...
                    # joint_lift_pos = joint_positions[i]
                    # joint_lift_action = create_default_motor_msg()
                    # joint_lift_action.mode = 0
                    # joint_lift_action.vel.linear.z = joint_lift_vel
                    # self.node.lift_publisher.publish(joint_lift_action)
                    # print("[debug]joint_lift_pos:", joint_lift_pos)
                    # print("[debug]joint_lift_vel:", joint_lift_vel)
