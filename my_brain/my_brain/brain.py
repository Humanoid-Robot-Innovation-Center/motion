...
class Brain(Node):
    ...
    def send_pickup_command(self):
        ...
        cmd = {
            "cmd_type":"pickup",
            "obj_type":"bottle",
            "image_rgb_url":"/home/ubuntu/codetest/my_konka1_motion/install/my_brain/share/my_brain/resource/rgb.png",
            "image_depth_url":"/home/ubuntu/codetest/my_konka1_motion/install/my_brain/share/my_brain/resource/depth.png",
            "detection_2d":{
                "left_top":[388, 231],
