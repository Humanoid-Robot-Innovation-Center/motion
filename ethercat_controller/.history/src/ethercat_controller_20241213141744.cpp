...
#include <ethercat_controller/msg/ControlCommand.hpp> // 替换为你的消息包和消息类型
...
public:
    ...
    : Node("ethercat_controller"), last_command_(std::nullopt)
    {
        ...
        // 创建订阅器
        command_subscription_ = this->create_subscription<ethercat_controller::msg::ControlCommand>(
...
private:
    std::optional<ethercat_controller::msg::ControlCommand::SharedPtr> last_command_;

    void control_command_callback(const ethercat_controller::msg::ControlCommand::SharedPtr msg)
    {
    ...
    void process_command(const ethercat_controller::msg::ControlCommand::SharedPtr msg)
    {
